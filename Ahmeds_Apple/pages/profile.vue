<template>
  <div>
    ...
    <input :type="showPassword ? 'text' : 'password'" v-model="user.oldPassword" id="oldPassword" placeholder="Old password" />
    <span class="eye-toggle" @click="togglePasswordVisibility">
      <i :class="eyeIconClass">
          ...
          <input :type="showPassword ? 'text' : 'password'" v-model="user.newPassword" id="newPassword" placeholder="New password" />
    <span class="eye-toggle" @click="togglePasswordVisibility">
      <i :class="eyeIconClass">
                  <link rel="stylesheet"
                    href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
          ...
          <label for="confirmPassword">Confirm Password:</label>
           <input :type="showPassword ? 'text' : 'password'" v-model="user.confirmPassword" id="confirmPassword" placeholder="Confirm password" />
    <span class="eye-toggle" @click="togglePasswordVisibility">
      <i :class="eyeIconClass">
                  <link rel="stylesheet"
                    href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
